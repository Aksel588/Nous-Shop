...
<table id="productTable">
    ...
    <div class="register">
        <div>
            <input type="text" name="search" id="searchProduct" placeholder="User name">
        </div>
    </div>


    <form action="./admin-server/menAdd-server.php" method="post">
        <tr class="register">
            <td>
    ...
    <?php foreach ($products as $product) : ?>
        <tr>
            ...
            <td><?php echo $product['sizeMen']; ?></td>
            <td><?php echo $product['company']; ?></td>
            <td>
                <a class="editMen" data-product-id="<?php echo $product['id']; ?>" href="#">
