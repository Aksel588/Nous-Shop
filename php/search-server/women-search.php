...
if (isset($_POST['search']) || isset($_POST['selectSize']) || (isset($_POST['minNum']) && isset($_POST['maxNum']))) {
    ...
    $query = "SELECT * FROM women WHERE 1=1";
    ...
    <div class="el-wrapper" id="el-wrapper">
        <div class="box-up">
            ...
            <div class="img-info">
                ...
                <div class="a-size">Available sizes: <span class="size">' . $product['sizeWomen'] . '</span></div>
            </div>
        </div>
        <div class="box-down">
            <div class="h-bg">
            ...
            <a class="cart" 
               ...
               data-product-size="' . $product['sizeWomen'] . '"
