...
if (isset($_POST['selectSize'])) {
    $menSize = '%' . $_POST['selectSize'] . '%';


    $query = "SELECT * FROM men WHERE sizeMen LIKE ?";
    $stmt = $connection->prepare($query);
    $stmt->bind_param("s", $menSize);
    $stmt->execute();
    ...
    <div class="el-wrapper" id="el-wrapper">
        <div class="box-up">
            ...
            <div class="img-info">
                ...
                <div class="a-size">Available sizes: <span class="size">' . $product['sizeMen'] . '</span></div>
            </div>
        </div>
        <div class="box-down">
            <div class="h-bg">
            ...
            <a class="cart" 
               ...
               data-product-size="' . $product['sizeMen'] . '"
